    ...
    <div className="max-w-[1280px] mx-auto flex flex-col items-center my-20">
      ...
      <div className='grid grid-cols-6 gap-6 mt-16'>
        {games.map(game => {
          ...
          return (
            <GameBanner key={game.id} bannerUrl={game.bannerUrl} name={game.name} adsCount={game._count.ads} />
          )
        })}
      </div>
      <Dialog.Root>
            ...
            <form className='mt-8 flex flex-col gap-4'>
              ...
              <div className='grid grid-cols-2 gap-6'>
                <div className='flex flex-col gap-2'>
                  ...
                  <Input id='discord' type='text' placeholder='Tudo bem ser ZERO' />
                </div>
              ...
              <footer className='mt-4 flex gap-4 justify-end'>
                <Dialog.Close type='button' className='bg-zinc-500 hover:bg-zinc-600 px-5 h-12 rounded-md font-semibold'>
                  Cancelar
                </Dialog.Close>
